...
$("#science-discovery").click(function(e) {
   ...
   activitymodal.find('.modal-body').text('Exploring is what we do best, why is the sky blue, why are rocks hard, these are some of the questions we hear and solve together. Using many different materials we provide a great learning environment. ');
...
$("#creative-art").click(function(e) {
   ...
   activitymodal.find('.modal-body').text("Free expression art is what it's all about, although younger children have more guided crafts they still have the opportunity to express themselves with numerous materials and art supplies.");
   $("#modal-header").css("background-color", "#ffdc4a");
   $("#modal-footer").css("background-color", "#ffdc4a");
   activitymodal.modal('show');	 
});
...
$("#outdoor").click(function(e) {
   ...
   " sandboxes, playhouses, water tables, and so much more!  ");
   $("#modal-header").css("background-color", "#ff8454");
   $("#modal-footer").css("background-color", "#ff8454");
   activitymodal.modal('show');	 
});
...
$("#based-play").click(function(e) {
   ...
   activitymodal.find('.modal-body').text("This allows children to play at individual/specific centers that have many toys and materials such as cooking, kitchen stuff for the theme of that center. This allows free expression with an organized feel. ");
   $("#modal-header").css("background-color", "#a8d79e");
   $("#modal-footer").css("background-color", "#a8d79e");
   activitymodal.modal('show');	 
});
...
$("#dramatic-play").click(function(e) {
   ...
   activitymodal.find('.modal-body').text("Let your inner actor out with a wide variety of dress up clothes and props!, building castle, professional actor, policeman, farmer, doctor.");
   $("#modal-header").css("background-color", "#ffdc4a");
   $("#modal-footer").css("background-color", "#ffdc4a");
   activitymodal.modal('show');	 
});
...
$("#learning-center").click(function(e) {
   ...
   activitymodal.find('.modal-body').text("We encourage children's learning through play. The children interact " + 
   " among themselves and develop the skills required for their individual growth, such as Social skills, cognitive " + 
   " skills, language skills, emotional skills, and physical skills. Children learn ABC's, 123's, counting, puzzle, songs, facts about different cultures etc.");
   $("#modal-header").css("background-color", "#a8d79e");
   $("#modal-footer").css("background-color", "#a8d79e");
   activitymodal.modal('show');	 
});